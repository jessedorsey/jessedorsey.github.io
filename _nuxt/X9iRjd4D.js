import{_ as k}from"./DlAUqK2U.js";import{b as l,g as T,z as x,c as P,o as L,a as t}from"./BMw0ieou.js";const M={class:"parallax-container"},S=["innerHTML"],D=["innerHTML"],b=["innerHTML"],j={__name:"ParallaxBit",setup(G){function a(r){return r.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}const g=[`use std::error::Error;
